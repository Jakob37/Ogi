...
"""
Interface for easily iteracting with SQLite database

Credits to: http://sebastianraschka.com/Articles/2014_sqlite_in_python_tutorial.html for providing the initial
...
# Previous default run commands - To be updated
